  ...
  $nama_gambar_baru = $angka_acak.'-'.$gambar_buku; //menggabungkan angka acak dengan nama file sebenarnya
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {     
                move_uploaded_file($file_tmp, 'gambar/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                  ...
                  $query = "INSERT INTO data (nama, judul, kelas, tanggal, gambar_buku) VALUES ('$nama', '$judul', '$kelas', '$tanggal', '$nama_gambar_baru')";
   ...
   $query = "INSERT INTO data (nama, judul, kelas, tanggal, gambar_buku) VALUES ('$nama', '$judul', '$kelas', '$tanggal', null)";
                  $result = mysqli_query($koneksi, $query);
                  // periska query apakah ada error
                  if(!$result){
                      die ("Query gagal dijalankan: ".mysqli_errno($koneksi).
